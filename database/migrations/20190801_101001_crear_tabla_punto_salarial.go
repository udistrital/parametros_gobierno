...
m.SQL("CREATE TABLE parametros_gobierno.punto_salarial(id serial NOT NULL, vigencia integer NOT NULL, valor numeric(10,2) NOT NULL, decreto varchar(255), activo boolean NOT NULL, fecha_creacion TIMESTAMP NOT NULL, fecha_modificacion TIMESTAMP NOT NULL, CONSTRAINT pk_punto_salarial PRIMARY KEY (id));")
